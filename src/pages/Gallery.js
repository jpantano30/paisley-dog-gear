...
const galleryImages = [
  ...
  { filename: "handsfree-redandblack2.JPG", caption: "Item: Hands-free leash system | Length: 7 ft | Width: 5/8 in | Colors: Red & Black | Hardware: black | Custom: Built-in traffic handle 18 in above base", type: "image" },
  { filename: "Turbo_gym.JPEG", caption: "Item: Custom collar with name plate | Width: 1 in with 5/8 in name plate | Colors: Deep Sea & Blue 52H | Hardware: silver | Custom: Biothane ID name plate", type: "image" },
  { filename: "navy&brown8ft.JPG", caption: "Item: Classic two-tone leash | Length: 8 ft | Width: 5/8 in | Colors: Deep Sea & Brown 522 | Hardware: silver", type: "image" },
  { filename: "coralnsagehandsfree.JPG", caption: "Item: Hands-free system | Length: 7 ft | Width: 5/8 in | Colors: Coral & Sage | Hardware: solid brass", type: "image" },
  { filename: "IMG_0078.JPG", caption: "Item: Braided Two Tone Leash | Length: 7 ft | Width: 5/8 in | Colors: Red & Forrest Green | Hardware: solid brass", type: "image" },
  { filename: "ball&leash.JPG", caption: "Item: Ball holder + leash set | Width: 5/8 in | Colors: Deep Sea & Brown 522 with matching ball holder | Hardware: silver", type: "image" },
  ...
  { filename: "littleone1.jpeg", caption: "Item: Matching collar + tether leash set | Width: 5/8 in | Colors: Amethyst Purple | Hardware: silver | Custom: HTV name on collar", type: "image" },
  { filename: "IMG_8763.JPG", caption: "Item: Traffic handle + collar set | Width: 5/8 in | Colors: Amethyst Purple & Pink 521 | Hardware: silver | Custom: Added floating O-ring for attachment", type: "image" },
  { filename: "collars_custom.JPG", caption: "Item: Custom collar collection | Widths: 5/8 in & 1 in | Colors: Multiple colorways | Hardware: silver | Custom: Examples of different color and style combinations", type: "image" },
  { filename: "b2.jpg", caption: "Item: Custom buckle collar | Width: 1 in | Colors: Orange 522 | Hardware: silver | Custom: Personalized name and phone; made with holes for an invisible-fence attachment", type: "image" },
  { filename: "leashextender.jpg", caption: "Item: Leash extender | Width: 5/8 in | Colors: Sage & White | Hardware: black | Use case: Clips between leash and collar to add length", type: "image" },
  { filename: "/leashpicsNvids/bella.jpg", caption: "Item: Standard leash upgraded with hands-free attachments | Length: 7 ft | Width: 5/8 in | Colors: Amethyst Purple & Violet | Hardware: silver | Custom: Hands-free attachments and HTV name", type: "image" },
  { filename: "tullycircle.JPG", caption: "Item: Trick training – hoop jump | Details: Tully jumping through hoop arms", type: "image" },
  { filename: "Turbo_painted.jpg", caption: "Item: Hand-painted collar | Width: 1 in with 5/8 in buckle | Colors: Deep Sea with custom artwork | Hardware: silver | Custom: Hand-painted design", type: "image" },
  { filename: "/leashpicsNvids/Pan.jpg", caption: "Item: Standard leash upgraded with hands-free attachments | Length: 7 ft | Width: 5/8 in | Colors: Blue 522 & Deep Sea | Hardware: silver | Custom: Hands-free attachments and HTV name", type: "image" },
  { filename: "custom-longline.jpg", caption: "Item: Custom long line | Length: 12 ft | Width: 5/8 in | Colors: Violet | Hardware: black with locking carabiner | Custom: Built-in traffic handle 18 in above base", type: "image" },
  { filename: "Littleone_collar.jpg", caption: "Item: Custom collar | Width: 5/8 in | Colors: Amethyst Orchid Purple | Hardware: silver | Custom: HTV name in fancy font", type: "image" },
  { filename: "sageNwhitecollar.jpg", caption: "Item: Buckle collar | Width: 5/8 in | Colors: Sage & White | Hardware: silver buckle with black plastic quick-release | Custom: Center O-ring", type: "image" },
  { filename: "/leashpicsNvids/red&bluecollar.JPG", caption: "Item: Quick-release collar | Width: 5/8 in | Colors: Red & Blue | Hardware: silver | Custom: Center O-ring", type: "image" },
  { filename: "IMG_5366 copy.JPG", caption: "Item: Custom collar designs | Widths: 5/8 in & 1 in | Colors: Amethyst Purple & Deep Sea base | Hardware: silver | Custom: Examples of widths and color layouts", type: "image" },
  { filename: "b4.jpg", caption: "Item: Custom buckle collar | Width: 1 in | Colors: Orange 522 | Hardware: silver | Custom: Personalized name and phone; made with holes for an invisible-fence attachment", type: "image" },
  { filename: "sageNwhiteCollar2.jpg", caption: "Item: Buckle collar | Width: 5/8 in | Colors: Sage & White | Hardware: silver buckle with black plastic quick-release | Custom: Center O-ring", type: "image" },
  { filename: "/leashpicsNvids/red&bluebuckle.JPG", caption: "Item: Buckle collar | Width: 5/8 in | Colors: Red & Blue | Hardware: silver | Custom: Center O-ring split", type: "image" },
  ...
  { filename: "/leashpicsNvids/traffichandleEdit.jpg", caption: "Item: Longer traffic handle | Width: 5/8 in | Colors: Pink & Black | Hardware: black | Custom: Floating O-ring plus Biothane slider to close the handle opening while walking to avoid tripping", type: "image" },
  { filename: "/leashpicsNvids/leashes2.jpg", caption: "Item: Sample leash styles | Widths: 5/8 in | Colors: Multiple | Hardware: mixed | Custom: Side-by-side comparison of color and style options", type: "image" },
  { filename: "set2.JPEG", caption: "Item: Sage & White set | Includes: Collar + leash + ball holder | Width: 5/8 in | Colors: Sage & White | Hardware: silver | Custom: Matching everyday set", type: "image" },
  { filename: "/leashpicsNvids/handsfreebasic.JPG", caption: "Item: Standard leashes with hands-free attachments | Length: 7 ft | Width: 5/8 in | Hardware: silver | Custom: Simple multi-clip hands-free configurations", type: "image" },
  { filename: "/leashpicsNvids/ballholder3.JPG", caption: "Item: Ball holder | Width: 5/8 in | Colors: Sage & White | Hardware: silver", type: "image" },
  { filename: "/leashpicsNvids/longlinerolled.JPG", caption: "Item: Long line | Length: 12 ft | Width: 5/8 in | Colors: Violet | Hardware: black | Custom: Rolled for storage; ideal for recall training and decompression walks", type: "image" },
  { filename: "/leashpicsNvids/customtraffichandle3.JPG", caption: "Item: Custom service-dog leash extender with built-in fishtail traffic handle | Width: 1 in | Colors: Black base with paracord fishtail in hot pink and green | Hardware: silver & black mix with special-order lobster-claw swivel snap | Custom: Mixed hardware colors, paracord fishtail traffic handle, and HTV phrase", type: "image" },
  { filename: "/leashpicsNvids/b&pstandard.JPG", caption: "Item: Standard leash | Length: 8 ft | Width: 5/8 in | Colors: Black & Pink | Hardware: black", type: "image" },
  { filename: "handsfree-redandblack1.JPG", caption: "Item: Hands-free leash system | Length: 7 ft | Width: 5/8 in | Colors: Red & Black | Hardware: black | Custom: Built-in traffic handle 18 in above base", type: "image" },
  { filename: "customname.jpg", caption: "Item: Custom HTV name detail | Width: 5/8 in | Colors: Violet with black lettering | Hardware: black | Custom: Heat-transfer vinyl name for personalization", type: "image" },
  { filename: "/leashpicsNvids/IMG_5161.JPG", caption: "Item: Longer traffic handle | Width: 5/8 in | Colors: Pink & Black | Hardware: black | Custom: Floating O-ring plus Biothane slider to close the handle opening while walking to avoid tripping", type: "image" },
  { filename: "thetallulah.jpg", caption: "Item: The Tallulah / hands-free leash system | Length: 8 ft | Width: 5/8 in | Colors: Sage & White | Hardware: black | Custom: Built-in traffic handle at base", type: "image" },
  { filename: "/leashpicsNvids/set3.jpg", caption: "Item: Sage & White set | Includes: Collar + leash + ball holder | Width: 5/8 in | Colors: Sage & White | Hardware: silver | Custom: Matching everyday set", type: "image" },
  { filename: "tullyw-customtraffichandle2.jpg", caption: "Item: Custom leash extender with paracord fishtail traffic handle | Width: 1 in | Colors: Black base with hot pink and green paracord fishtail | Hardware: silver | Custom: Extender and paracord traffic handle combo used by Tully", type: "image" },
  { filename: "fishtail2.jpg", caption: "Item: Fishtail braid traffic handle | Material: paracord | Colors: Hot Pink & Green | Custom: Thick fishtail pattern for extra grip", type: "image" },
  { filename: "/leashpicsNvids/IMG_5139.JPG", caption: "Item: Fishtail braid traffic handle (alternate view) | Material: paracord | Colors: Hot Pink & Green | Custom: Decorative and functional handle option", type: "image" },
  { filename: "leashextendorastraffichandle2.jpg", caption: "Item: Leash extender as traffic handle | Width: 5/8 in | Colors: Sage & White | Hardware: black | Custom: Demonstrates extender clipped as a short handle", type: "image" },
  { filename: "leashextendorastraffichandle.jpg", caption: "Item: Extender used as traffic handle | Width: 5/8 in | Colors: Sage & White | Hardware: black | Custom: Dual-purpose extender/handle setup", type: "image" },
  { filename: "tullyontheTallulah.jpg", caption: "Item: The Tallulah used as long line | Width: 5/8 in | Colors: Sage & White | Hardware: black | Custom: Example of Tallulah system clipped as a long line for Tully using the additional leash extender", type: "image" },
  { filename: "tullystrap.jpg", caption: "Item: Safety strap | Material: paracord weave | Colors: Hot Pink & Black | Hardware: silver | Custom: Backup strap between prong collar and regular collar", type: "image" },
  { filename: "PaisleyCollar.jpg", caption: "Item: Sage & White collar | Width: 5/8 in | Colors: Sage & White | Hardware: silver | Custom: Everyday collar modeled by Paisley", type: "image" },
  { filename: "PaisleyCollar2.jpg", caption: "Item: Sage & White collar | Width: 5/8 in | Colors: Sage & White | Hardware: silver | Custom: Alternate angle on Paisley’s collar fit", type: "image" },
  { filename: "lo_collarleash.jpg", caption: "Item: Collar + tether leash set | Width: 5/8 in | Colors: Amethyst Purple | Hardware: silver | Custom: Matching set modeled by Little One", type: "image" },
...
function GearCaption({ text }) {
  ...
  return (
    <div className="caption-card">
      <p className="caption-item">
        {itemPart.replace(/^Item:\s*/i, "")}
      </p>
      {metaParts.length > 0 && (
